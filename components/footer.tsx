            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://www.instagram.com/p/DN8E0MgCKlL/?igsh=ejZwM3BpcWwwenNs"
                  className="w-12 h-12 bg-sec-300 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"
                >
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://x.com/joinmelonhq/status/1961404362401497542?s=46"
                  className="w-12 h-12 bg-sec-300 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"
                >
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-black">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://www.facebook.com/share/17D7KdB76Q/?mibextid=wwXIfr"
                  className="w-12 h-12 bg-sec-300 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"
                >
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://www.linkedin.com/company/melon-insurance-app"
                  className="w-12 h-12 bg-sec-300 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"
                >
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://www.tiktok.com/@joinmelonhq?_t=ZM-8zdo9L5eO3x&_r=1"
                  className="w-12 h-12 bg-sec-300 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors"
                >
                  <svg viewBox="0 0 24 24" className="w-6 h-6 fill-black">
