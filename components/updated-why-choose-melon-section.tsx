...
export function UpdatedWhyChooseMelonSection() {
  const benefits = [
    {
      icon: Smartphone,
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#005bae] to-[#004a94]">
          ...
          {benefits.map((benefit, index) => (
            <div key={index} className="text-center text-white space-y-4">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-[#04c751] rounded-lg flex items-center justify-center">
