      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Melon is designed for everyday life. Whoever you are, Melon makes health coverage simple and accessible.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className={`${audiences[1].bgColor} rounded-3xl p-8 relative overflow-hidden min-h-[400px]`}>
              <h3 className={`text-2xl lg:text-3xl font-normal ${audiences[1].textColor} mb-6 max-w-xs leading-tight`}>
                {audiences[1].title}
              </h3>
              <div className="absolute bottom-0 right-0 w-full h-3/5">
                <img
            ...
            <div className={`${audiences[3].bgColor} rounded-3xl p-8 relative overflow-hidden min-h-[400px]`}>
              <h3 className={`text-2xl lg:text-3xl font-normal ${audiences[3].textColor} mb-6 max-w-xs leading-tight`}>
                {audiences[3].title}
              </h3>
              <div className="absolute bottom-0 right-0 w-full h-3/5">
                <img
            ...
            {/* Diaspora - Small card */}
            <div className={`${audiences[4].bgColor} rounded-3xl p-8 relative overflow-hidden min-h-[400px]`}>
              <h3 className={`text-2xl lg:text-3xl font-normal ${audiences[4].textColor} mb-6 max-w-xs leading-tight`}>
                {audiences[4].title}
              </h3>
              <div className="absolute bottom-0 right-0 w-full h-3/5">
                <img
